...
public class ProceduralCylinder : MonoBehaviour {
    ...
    [SerializeField] int nbSides = 24;
    [SerializeField] float bottomRadius1 = .5f;
    [SerializeField] float bottomRadius2 = .15f;
    [SerializeField] float topRadius1 = .5f;
    [SerializeField] float topRadius2 = .15f;
